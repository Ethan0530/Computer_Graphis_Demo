...
void fillHair(){
    Point points01[] = {{422,533},{369,489},{338,451},{345,455},{365,517},{341,497},{340,510},{318,475},{303,435},{296,400},{296,370},{303,329},{315,276},{370,145},{396,108},{488,59},{540,50},{540,90},{473,95}};
    Polygon_Point polygon01 = {
        .point_num = sizeof(points01) / sizeof(Point),//计算顶点数量
        .points = points01,//设置顶点数组
    };
