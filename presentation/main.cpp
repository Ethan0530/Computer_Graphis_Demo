...
void draw_Left(){
    ...
    line(253,800,250,810);
    line(252,800,249,810);
    line(251,800,248,810);
    line(250,800,247,810);
    
    line(250,810,250,818);
    line(249,810,249,818);
    line(248,810,248,818);
    line(247,810,247,818);

    line(250,819,285,841);
    line(250,818,285,840);
    line(250,817,285,839);
    line(250,816,285,838);

    line(285,838,313,844);
    line(285,839,313,845);
    line(285,840,313,846);
    line(285,841,313,847);

    line(313,844,326,844);
    line(313,845,326,845);
    line(313,846,326,846);
    line(313,847,326,847);
...
void fillRing(){
    Point points01[] = {{303,832},{324,833},{324,847},{305,846},{248,818},{248,805},{253,807},{255,807}};
    Polygon_Point polygon01 = {
        .point_num = sizeof(points01) / sizeof(Point),//计算顶点数量
        .points = points01,//设置顶点数组
    };
    polyfill(polygon01,RGB(136,227,134));

    Point points02[] = {{777,832},{756,833},{756,847},{775,846},{832,818},{832,805},{827,807},{825,807}};
    Polygon_Point polygon02 = {
        .point_num = sizeof(points02) / sizeof(Point),//计算顶点数量
        .points = points02,//设置顶点数组
    };
    polyfill(polygon02,RGB(136,227,134));
}
...
void draw_Right(){
    ...
    //袖子上的装饰环
    setcolor(RGB(10,54,5));
    line(827,800,830,810);
    line(828,800,831,810);
    line(829,800,832,810);
    line(830,800,833,810);
    
    line(830,810,830,818);
    line(831,810,831,818);
    line(832,810,832,818);
    line(833,810,833,818);

    line(830,819,795,841);
    line(830,818,795,840);
    line(830,817,795,839);
    line(830,816,795,838);

    line(795,838,767,844);
    line(795,839,767,845);
    line(795,840,767,846);
    line(795,841,767,847);

    line(767,844,754,844);
    line(767,845,754,845);
    line(767,846,754,846);
    line(767,847,754,847);
...
void fillHair(){
    Point points01[] = {{422,533},{369,489},{338,451},{345,455},{365,517},{341,497},{340,510},{318,475},{303,435},{296,400},{296,370},{303,329},{315,276},{370,145},{396,108},{488,59},{540,50},{540,90},{473,95},{453,148},{540,133},{540,375},{497,309},{481,245},{482,200},{450,300},{440,378},{421,342},{413,400},{394,379},{393,402}};
    Polygon_Point polygon01 = {
        .point_num = sizeof(points01) / sizeof(Point),//计算顶点数量
        .points = points01,//设置顶点数组
    };
    ...
    Point points02[] = {{658, 533}, {711, 489}, {742, 451}, {735, 455}, {715, 517}, {739, 497}, {740, 510}, {762, 475}, {777, 435}, {784, 400}, {784, 370}, {779, 329}, {766, 276}, {710, 145}, {684, 108}, {592, 59}, {540, 50}, {540, 90}, {607, 95}, {627, 148}, {540, 133}, {540, 375}, {583, 309}, {599, 245}, {598, 200}, {630, 300}, {640, 378}, {659, 342}, {667, 400}, {686, 379}, {687, 402}};
    Polygon_Point polygon02 = {
        .point_num = sizeof(points02) / sizeof(Point),//计算顶点数量
        .points = points02,//设置顶点数组
    };
    polyfill(polygon02,RGB(182,149,130));

    Point points03[] = {{472,96},{455,145},{540,132},{625,145},{608,96},{540,89}};
    Polygon_Point polygon03 = {
        .point_num = sizeof(points03) / sizeof(Point),//计算顶点数量
        .points = points03,//设置顶点数组
    };
...
void drawEye(){
    ...
    setcolor(RGB(99,85,74));
    //左眉毛
    line(453,323,467,314);
    line(453,322,467,313);
    line(453,321,467,312);
    line(453,320,467,311);

    line(467,314,472,312);
    line(467,313,472,311);
    line(467,312,472,310);
    line(467,311,472,309);

    line(472,312,481,312);
    line(472,311,481,311);
    line(472,310,481,310);
    line(472,309,481,309);

    line(481,312,491,317);
    line(481,311,492,317);
    line(481,310,493,317);
    line(481,309,494,317);

    //右眉毛
    line(627,323,613,314);
    line(627,322,613,313);
    line(627,321,613,312);
    line(627,320,613,311);

    line(613,314,608,312);
    line(613,313,608,311);
    line(613,312,608,310);
    line(613,311,608,309);

    line(608,312,599,312);
    line(608,311,599,311);
    line(608,310,599,310);
    line(608,309,599,309);

    line(599,312,589,317);
    line(599,311,588,317);
    line(599,310,587,317);
    line(599,309,586,317);

    //嘴唇
    setcolor(RGB(253,135,135));
    line(526,439,536,443);
    line(526,440,536,444);
    line(526,441,536,445);
    line(526,442,536,446);

    line(554,439,544,443);
    line(554,440,544,444);
    line(554,441,544,445);
    line(554,442,544,446);

    line(536,443,544,443);
    line(536,444,544,444);
    line(536,445,544,445);
    line(536,446,544,446);
...
void drawTie(){
    ...
    //下层领结
    Point points04[] = {{520,582},{480,687},{510,700}};
    Polygon_Point polygon04 = {
        .point_num = sizeof(points04) / sizeof(Point),//计算顶点数量
        .points = points04,//设置顶点数组
    };
    polyfill(polygon04,RGB(137,227,129));

    Point points05[] = {{560,582},{600,687},{570,700}};
    Polygon_Point polygon05 = {
        .point_num = sizeof(points05) / sizeof(Point),//计算顶点数量
        .points = points05,//设置顶点数组
    };
    polyfill(polygon05,RGB(137,227,129));

    setcolor(RGB(10,54,5));
    line(520,582,480,687);
    line(519,582,479,687);
    line(518,582,478,687);
    line(517,582,477,687);

    line(480,684,510,700);
    line(480,685,510,701);
    line(480,686,510,702);
    line(480,687,510,703);

    line(509,700,519,582);
    line(508,700,518,582);
    line(507,700,517,582);

    line(560,582,600,687);
    line(561,582,601,687);
    line(562,582,602,687);
    line(563,582,603,687);

    line(600,684,570,700);
    line(600,685,570,701);
    line(600,686,570,702);
    line(600,687,570,703);

    line(571,700,561,582);
    line(572,700,562,582);
    line(573,700,563,582);

    //上层领结
    Point points02[] = {{538,547},{540,551},{515,620},{492,598}};
    Polygon_Point polygon02 = {
        .point_num = sizeof(points02) / sizeof(Point),//计算顶点数量
        .points = points02,//设置顶点数组
    };
    ...
    Point points03[] = {{542,547},{540,551},{565,620},{588,598}};
    Polygon_Point polygon03 = {
        .point_num = sizeof(points03) / sizeof(Point),//计算顶点数量
        .points = points03,//设置顶点数组
    };
    ...
    line(504,541,540,550);
    line(504,542,540,551);
    line(504,543,540,552);
    line(504,544,540,553);

    line(511,535,540,540);
    line(511,534,540,539);
    line(511,533,540,538);
    line(511,532,540,537);

    line(576,541,540,550);
    line(576,542,540,551);
    line(576,543,540,552);
    line(576,544,540,553);

    line(569,535,540,540);
    line(569,534,540,539);
    line(569,533,540,538);
    line(569,532,540,537);

    line(542,547,588,598);
    line(543,547,589,598);
    line(544,547,590,598);
    line(545,547,591,598);

    line(588,598,565,620);
    line(589,598,565,621);
    line(590,598,565,622);
    line(591,598,565,623);

    line(565,620,543,550);
    line(565,621,542,550);
    line(565,622,541,550);
    line(565,623,540,550);

    line(538,547,492,598);
    line(537,547,491,598);
    line(536,547,490,598);
    line(535,547,489,598);

    line(492,598,515,620);
    line(491,598,515,621);
    line(490,598,515,622);
    line(489,598,515,623);

    line(515,620,537,550);
    line(515,621,538,550);
    line(515,622,539,550);
    line(515,623,540,550);

    setcolor(RGB(3,61,2));//圆的线条颜色 
	setfillcolor(RGB(137,227,129));//圆的填充颜色
    circle(540,545,6);
    circle(540,545,7);
    circle(540,545,8);
    circle(540,545,9);
    circle(540,545,10);
    fillcircle(540,545,6);//圆心，半径
}
...
int main(){
    ...
    saveimage("E:\\git_workplace\\Computer_Graphis_Demo\\presentation\\test.jpg",&img);
